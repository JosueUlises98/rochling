package org.kopingenieria.model.classes.serialization.out.serializables;

import com.fasterxml.jackson.annotation.*;
import jakarta.validation.constraints.NotNull;
import lombok.*;
import org.kopingenieria.model.classes.OpcUaConfiguration;
...
public class OpcUaConfigurationSerializable extends OpcUaSerializable {
    ...
    public OpcUaConfigurationSerializable(OpcUaConfigurationSerializable source) {
    ...
    public OpcUaConfigurationSerializable clone() {
        try {
            OpcUaConfigurationSerializable clone = (OpcUaConfigurationSerializable) super.clone();
