...
public class DefaultConfigFile {
    ...
    private void authenticationToProperties(DefaultConfiguration config) {
        ...
        props.setProperty("opcua.default.authentication.securityPolicyUri",auth.getSecurityPolicyUri());
    ...
    private void encryptionToProperties(DefaultConfiguration config) {
        ...
        props.setProperty("opcua.default.encryption.algorithmName", enc.getAlgorithmName());
    ...
    private void sessionToProperties(DefaultConfiguration config) {
        ...
        props.setProperty("opcua.default.session.securityPolicyUri", session.getSecurityPolicyUri());
