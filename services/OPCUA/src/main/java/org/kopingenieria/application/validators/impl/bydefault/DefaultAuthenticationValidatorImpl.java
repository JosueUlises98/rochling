...
import org.kopingenieria.application.validators.contract.bydefault.DefaultAuthenticationValidator;
...
public class DefaultAuthenticationValidatorImpl implements DefaultAuthenticationValidator {
    ...
    public boolean validateDefaultCredentials(String username, String password) {
    ...
    public boolean validateDefaultCertificate(String certificate) {
    ...
    public String getValidationResult(String[] data,Object[]sessiondata){
        ...
        if(validateDefaultCredentials(data[0],data[1])&validateDefaultCertificate(data[2])&isSessionValid(data[3],sessiondata)&isSessionTokenValid(data[3])&enforcePasswordComplexity(data[1])){
            result = "success";
        }
        return result;
    }
