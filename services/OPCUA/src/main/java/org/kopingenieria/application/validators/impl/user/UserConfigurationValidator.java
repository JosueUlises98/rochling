...
public class UserConfigurationValidator {
    ...
    public void validateConnection(UserConfiguration config) throws ConfigurationException {
    ...
    public void validateAuthentication(UserConfiguration config) throws ConfigurationException {
        Objects.requireNonNull(config,"La configuracion es obligatoria");
    ...
    public void validateEncryption(UserConfiguration config) throws ConfigurationException {
        Objects.requireNonNull(config,"La configuracion es obligatoria");
    ...
    public void validateSession(UserConfiguration config) throws ConfigurationException {
        Objects.requireNonNull(config,"La configuracion es obligatoria");
    ...
    public void validateSubscription(UserConfiguration config) throws ConfigurationException {
        Objects.requireNonNull(config,"La configuracion es obligatoria");
    ...
    public void validateIndustrialConfiguration(UserConfiguration config) throws ConfigurationException {
        Objects.requireNonNull(config,"La configuracion es obligatoria");
    ...
    private boolean isValidConnectionTimeout(Long timeout) {
        return timeout != null && utimeot >= 0 && timeout <= Timeouts.CONNECTION.toMilliseconds();
    }
