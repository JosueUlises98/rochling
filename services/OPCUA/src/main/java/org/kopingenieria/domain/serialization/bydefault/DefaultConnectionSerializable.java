...
import org.kopingenieria.domain.model.user.UserConnectionConfiguration;
...
public class DefaultConnectionSerializable extends DefaultOpcUaSerializable {
    ...
    public DefaultConnectionSerializable(DefaultConnectionSerializable source) {
    ...
    public DefaultConnectionSerializable clone() {
        try {
            DefaultConnectionSerializable clone = (DefaultConnectionSerializable) super.clone();
