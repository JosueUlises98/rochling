...
public class DefaultSessionSerializable extends DefaultOpcUaSerializable {
    ...
    public DefaultSessionSerializable(DefaultSessionSerializable source) {
        super();
    ...
    public DefaultSessionSerializable clone() {
        try {
            DefaultSessionSerializable clone = (DefaultSessionSerializable) super.clone();
