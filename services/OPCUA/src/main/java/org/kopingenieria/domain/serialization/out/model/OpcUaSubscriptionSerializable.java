...
import lombok.*;
import org.kopingenieria.domain.model.SubscriptionConfiguration;
...
public class OpcUaSubscriptionSerializable extends OpcUaSerializable {
    ...
    public OpcUaSubscriptionSerializable(OpcUaSubscriptionSerializable source) {
    ...
    public OpcUaSubscriptionSerializable clone() {
        try {
            OpcUaSubscriptionSerializable clone = (OpcUaSubscriptionSerializable) super.clone();
