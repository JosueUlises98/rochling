...
public class UserConnectionSerializable extends UserOpcUaSerializable {
    ...
    public UserConnectionSerializable(UserConnectionSerializable source) {
    ...
    public UserConnectionSerializable clone() {
        try {
            UserConnectionSerializable clone = (UserConnectionSerializable) super.clone();
