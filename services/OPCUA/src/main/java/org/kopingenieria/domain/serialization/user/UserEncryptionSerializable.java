...
import lombok.*;
import org.kopingenieria.domain.model.user.UserEncryptionConfiguration;
...
public class UserEncryptionSerializable extends UserOpcUaSerializable {
    ...
    public UserEncryptionSerializable(UserEncryptionSerializable source) {
    ...
    public UserEncryptionSerializable clone() {
        try {
            UserEncryptionSerializable clone = (UserEncryptionSerializable) super.clone();
