...
public class UserSessionSerializable extends UserOpcUaSerializable {
    ...
    public UserSessionSerializable(UserSessionSerializable source) {
        super();
    ...
    public UserSessionSerializable clone() {
        try {
            UserSessionSerializable clone = (UserSessionSerializable) super.clone();
