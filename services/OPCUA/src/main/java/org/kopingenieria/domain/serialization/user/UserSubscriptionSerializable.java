...
import lombok.*;
import org.kopingenieria.domain.model.user.UserSubscriptionConfiguration;
...
public class UserSubscriptionSerializable extends UserOpcUaSerializable {
    ...
    public UserSubscriptionSerializable(UserSubscriptionSerializable source) {
    ...
    public UserSubscriptionSerializable clone() {
        try {
            UserSubscriptionSerializable clone = (UserSubscriptionSerializable) super.clone();
